...
import { View, Text, FlatList, StyleSheet, Pressable, Dimensions, ScrollView, Alert } from 'react-native';
...
export default function DeckDetailScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        data={(deck.matches || []).filter((m) => filter === 'all' ? true : m.result === filter)}
